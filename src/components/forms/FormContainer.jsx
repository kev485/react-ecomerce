...
const FormContainer = ({ cerrarModal, productoEditar = null }) => {
    ...
    // pre-llenamos el formulario si venimos en modo editar
    useEffect(() => {
        if (productoEditar) {
            setDatosForm({
    ...
    // Sube la imagen a  ImgBB y deevuelve la URL, o null si falla
    ...
    const manejarEnvio = async (e) => {
        ...
        try {
            ...
            // si no entramos aca en modo editar    
                ...
                await editarProducto(productosEditar.id, datosActualizados);
            ...
            alert("Ocurrio un error. Revisá la consola.");
        } finally {
            setCargando(false);
        }
    };
